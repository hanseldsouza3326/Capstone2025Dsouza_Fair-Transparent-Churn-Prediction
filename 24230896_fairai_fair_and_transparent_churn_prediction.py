...
# AI Assistance: Parts of this code were cross checked with assistance from AI.
# specifically gating mechanism was refined with assistance from AI.
...
# AI Assistance: Parts of this code was cross checked with assistance from AI.
# This fairness analysis code for calculating Disparate Impact (DI) was referred for understanding the flow.
